# KargoRapor İlk Güvenli Sürüm

- [x] Takip numarası çıktısındaki XSS riskini kaldır.
- [x] Form alanlarına erişilebilir etiketler ve güvenli doğrulama ekle.
- [x] Mobil tablo taşmasını düzelt.
- [x] Gizlilik, çerez, KVKK, kullanım şartları ve iletişim sayfalarını ekle.
